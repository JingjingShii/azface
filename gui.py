...
MODEL = "Azure Face"
CMD_DETECT = ["ml", "detect", "azface"]
CMD_SIMILAR = ["ml", "similar", "azface"]

DEFAULT_PATH = "Enter a local path to an image (jpg, png) file"
DEFAULT_IMAGE = os.path.join(os.getcwd(), "docs/photo/detection/detection6.jpg")
...
class MLHub(wx.Frame):
    ...
    def InitUI(self):
        ...
        self.images_dir = os.path.join(os.getcwd(), "docs/photo/detection")
        ...
        # DETECT
        bt_ocr = wx.Button(panel, label="DETECT")
        bt_ocr.Bind(wx.EVT_BUTTON, self.OnDETECT)
